<?php 
  /**
   * Conecta con la base de datos MySQL local usando el controlador mysqli.
   * Configura el conjunto de caracteres a UTF-8 para evitar problemas con tildes y caracteres especiales.
   * Retorna el objeto de conexión si es exitoso.
   */
	function conectarSocioBienes() {
  ...
  /**
   * Verifica si la sesión corresponde a un usuario de tipo "Cliente" ('u').
   * Si la sesión no es válida, intenta restaurarla desde las cookies ('datos').
   * Si no se cumple ninguna condición, redirige al usuario a la página de inicio.
   */
  ...
  /**
   * Verifica si el usuario actual tiene privilegios de "Administrador" ('a').
   * En caso negativo o de no haber una sesión activa, lo redirige al index.php principal.
   */
  ...
  /**
   * Intenta recuperar la sesión del usuario en la página index.php.
   * Decodifica los datos guardados en las cookies persistentes si existen.
   */
  function validarSesionIndex() {
    if (isset($_SESSION['tipo'])) {
      ...
      // No existe sesión activa en este momento
    }
  }
        ...
        echo " <nav class='menu navbar navbar-inverse navbar-fixed-top texto'>
                    <div class='container-fluid'>
                      ...
                      <ul class='nav navbar-nav navbar-right'>
                        ...
                        <li><a href='mensajes_contacto.php'><span class='glyphicon glyphicon-envelope'></span> Mensajes</a></li>
                        <li><a href='cerrrarsesion.php'><span class='glyphicon glyphicon-log-in'></span> Cerrar sesión</a></li>
                      </ul>
                      </div>
                    </div>
        ...
        echo "<nav class='menu navbar navbar-inverse navbar-fixed-top texto'>
            <div class='container-fluid'>
              ...
              <ul class='nav navbar-nav navbar-right'>
                ...
                <li><a href='quienes_somos.php'><span class='glyphicon glyphicon-info-sign'></span> Quiénes Somos</a></li>
  ...
  function renderizarNavegacionInicio() {
    if (isset($_SESSION['tipo'])) {
      $tipo_usuario = $_SESSION['tipo'];
      if ($tipo_usuario == 'u') {
        echo " <nav class='menu navbar navbar-inverse navbar-fixed-top texto'>
        ...
        echo " <nav class='menu navbar navbar-inverse navbar-fixed-top texto'>
                    <div class='container-fluid'>
                      ...
                      <ul class='nav navbar-nav navbar-right'>
                        ...
                        <li><a href='./php/mensajes_contacto.php'><span class='glyphicon glyphicon-envelope'></span> Mensajes</a></li>
      ...
      echo "<nav class='menu navbar navbar-inverse navbar-fixed-top texto'>
            <div class='container-fluid'>
              ...
              <ul class='nav navbar-nav navbar-right'>
                <li><a href='./php/ver_todos.php'><span class='glyphicon glyphicon-briefcase'></span> Inmuebles</a></li>
                <li><a href='./php/quienes_somos.php'><span class='glyphicon glyphicon-info-sign'></span> Quiénes Somos</a></li>
                <li><a href='./php/contacto.php'><span class='glyphicon glyphicon-envelope'></span> Contacto</a></li>
  ...
  function dibujarCalendarioVisitas($dia, $mes, $anio) {
      ...
      $consulta = "select fecha from citas where fecha like '$anio-$mes_formateado-%'";
      ...
      if (!$fechas) {
        ...
        while ($fila = mysqli_fetch_array($fechas,MYSQLI_ASSOC)) {
          ...
          $dia_cita = intval(date('d',$fe_marca));
          if ($mesA == $mes) {
            array_push($citas_mes, $dia_cita);
          }
        }
      }
          ...
          for ($i = 1; $i <= 7; $i++) {
            ...
            if (isset($dias_mes[$i])) {
              ...
              if (in_array($dias_mes[$i],$citas_mes)) { //busca en el array citas el numero del dia / aquí si hay cita
                ...
                $dia_formateado = str_pad($dias_mes[$i], 2, '0', STR_PAD_LEFT);
                $fecha_consulta = "$anio-$mes_formateado-$dia_formateado";
                $sql = "select motivo,hora,lugar from citas where fecha='$fecha_consulta'";
