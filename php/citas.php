...
<html lang="es">
  ...
  <body>
    ...
    <div class="container-fluid submenu-admin">
      <div class="row">
        <div class="col-xs-12">
          <a class="btn btn-success btn-lg" href="nueva_cita.php"><span class="glyphicon glyphicon-plus"></span> Añadir cita</a>
          <a class="btn btn-danger btn-lg" href="borrar_citas.php"><span class="glyphicon glyphicon-trash"></span> Borrar citas</a>
          <a class="btn btn-info btn-lg" href="buscar_citas.php"><span class="glyphicon glyphicon-search"></span> Buscar citas</a>
        </div>
      </div>
    </div>
         ...
         <!-- Calendario -->
          <div class="col-xs-12 col-md-6">
            ...
            <?php 
              ...
              if($mes < 10) $mes = "0$mes";
            dibujarCalendarioVisitas($dia, $mes, $anio);?>
